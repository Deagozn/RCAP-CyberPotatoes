...
int ftorder;
int fOrder = -1;
int fDOT[] = { 1,4,1,1,1,1,2,2,3,3,2,2,2,2,1,1 }; //Fastturn
...
void Game0()
{
    ...
    else if (StnID >= 1 && StnID <= 100 && StnDist >= 5 && StnDist <= 10)
    {
    ...
    else if (NavID == 29 && NavDist >= 125 && NavDist <= 132 && not_done[9 - 1] == 1 || NavID == 11 && NavDist >= 87 && NavDist <= 92 || NavID == 19 && NavDist >= 10 && NavDist <= 14 || NavID == 32 && NavDist >= 10 && NavDist <= 14 || NavID == 3 && NavDist >= 10 && NavDist <= 14 || NavID == 15 && NavDist >= 10 && NavDist <= 14 || NavID == 17 && NavDist >= nav_dist_u && NavDist <= nav_dist_p || NavID == 7 && NavDist >= nav_dist_u && NavDist <= nav_dist_p || NavID == 28 && NavDist >= nav_dist_u && NavDist <= nav_dist_p || NavID == 9 && NavDist >= nav_dist_u && NavDist <= nav_dist_p || NavID == 5 && NavDist >= 23 && NavDist <= 31 || NavID == 16 && NavDist >= 23 && NavDist <= 31 || NavID == 21 && NavDist >= nav_dist_u && NavDist <= nav_dist_p || NavID == 12 && NavDist >= nav_dist_u && NavDist <= nav_dist_p || NavID == 13 && NavDist >= 11 && NavDist <= 17)
    {
        ...
        else if (NavID == 11 && NavDist >= nav_dist_u && nav_dist_p && not_done[1 - 1] == 1)
        {
            Duration == 18;
        }
        else
