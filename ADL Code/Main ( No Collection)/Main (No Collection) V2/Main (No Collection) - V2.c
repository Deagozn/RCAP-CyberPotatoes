...
void Game0()
{
    ...
    else if (NavID == 19 && NavDist >= -1 && NavDist <= 1 || NavID == 4 && NavDist >= -1 && NavDist <= 1 || NavID == 14 && NavDist >= -1 && NavDist <= 1)
    {
        kp = 0.93;
        ki = 0.000010;
        kd = 14;
    ...
    else if (NavID == 20 && NavDist >= -1 && NavDist <= 1 || NavID == 3 && NavDist >= -1 && NavDist <= 1 || NavID == 15 && NavDist >= -1 && NavDist <= 1)
    {
        kp = 0.85;
        ki = 0.010;
        kd = 6.9;
