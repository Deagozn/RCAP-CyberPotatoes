...
void Game0()
{
    ...
    else if (StnID >= 1 && StnID <= 100 && StnDist >= 5 && StnDist <= 9)
    {
    ...
    else if (NavID == 29 && NavDist >= 125 && NavDist <= 132 && not_done[9 - 1] == 1 || NavID == 11 && NavDist >= 87 && NavDist <= 92 || NavID == 19 && NavDist >= 10 && NavDist <= 14 || NavID == 32 && NavDist >= 10 && NavDist <= 14 || NavID == 3 && NavDist >= 10 && NavDist <= 14 || NavID == 15 && NavDist >= 10 && NavDist <= 14 || NavID == 17 && NavDist >= nav_dist_u && NavDist <= nav_dist_p || NavID == 7 && NavDist >= nav_dist_u && NavDist <= nav_dist_p || NavID == 28 && NavDist >= nav_dist_u && NavDist <= nav_dist_p || NavID == 9 && NavDist >= nav_dist_u && NavDist <= nav_dist_p || NavID == 5 && NavDist >= 23 && NavDist <= 31 || NavID == 16 && NavDist >= 22 && NavDist <= 30 || NavID == 21 && NavDist >= nav_dist_u && NavDist <= nav_dist_p || NavID == 12 && NavDist >= nav_dist_u && NavDist <= nav_dist_p || NavID == 13 && NavDist >= 11 && NavDist <= 17)
    {
        if (NavID == point_order[curr_turn])
        {
            if (NavID == 11 && NavDist >= 89 && NavDist <= 94 || NavID == 19 && NavDist >= 13 && NavDist <= 18 || NavID == 32 && NavDist >= 13 && NavDist <= 18 || NavID == 3 && NavDist >= 13 && NavDist <= 18 || NavID == 13 && NavDist >= 11 && NavDist <= 18)
            {
                Duration = 25;
            }
            else if (NavID == 17 && NavDist >= nav_dist_u-4 && NavDist <= nav_dist_p-4 && not_done[1 - 1] == 1)
            {
                Duration = 20;
            }
            else
