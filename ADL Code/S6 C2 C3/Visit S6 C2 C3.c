...
void Game0()
{
    ...
    else if (StnID >= 6 && StnID <= 6 && StnDist >= 0 && StnDist <= 0)
    {
        if (not_done[StnID - 1] == 0)
        {
            Duration = 85;
            CurAction = 1;
            if (StnID == 1 && StnDist >= 0 && StnDist <= 0 || StnID == 10 && StnDist >= 0 && StnDist <= 0 || StnID == 8 && StnDist >= 0 && StnDist <= 0)
            {
                turn180 = 1;
            }
            not_done[StnID - 1] = 1;
    ...
    else if (NavID == 18 && NavDist <= 4 || NavID == 30 && NavDist <= 4)
    {
        Duration = 10;
        CurAction = 2;
        Order++;
    ...
    case 4:
        ...
        LED = 0;
        turn180 = 0;
        if (Duration < 15) // Go Forward to Leave Center.
        {
            WheelLeft = 100;
            WheelRight = 100;
        }
